...
describe('AlchemyService', () => {
  ...
  describe('factory function and exports', () => {
    ...
    it('should NOT export default alchemyService singleton instance', async () => {
      const alchemyServiceModule = await import('../alchemyService');

      expect('alchemyService' in alchemyServiceModule).toBe(false);
    });
  ...
  describe('createAlchemyService factory function', () => {
    it('should return an AlchemyService instance', async () => {
      const { createAlchemyService, AlchemyService } = await import('../alchemyService');
      const service = createAlchemyService();
      expect(service).toBeInstanceOf(AlchemyService);
    });
    ...
    it('should have all expected methods', async () => {
      const { createAlchemyService } = await import('../alchemyService');
      const service = createAlchemyService();
